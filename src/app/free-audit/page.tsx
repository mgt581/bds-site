...
export const metadata = {
  title: 'Free Website & SEO Audit | Bryant Digital Solutions',
  description:
    'Get an instant, comprehensive SEO audit covering technical health, on-page SEO, performance, local search visibility, and accessibility — with a clear action plan.',
}
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-brand-dark to-[#122a45]">
      <header className="mx-auto flex max-w-6xl items-center justify-between px-4 py-6">
        <a href="/legacy/index.html" className="text-lg font-extrabold tracking-wide text-white">
          BRYANT DIGITAL <span className="text-brand-gold">SOLUTIONS</span>
        </a>
        <a
          href="/legacy/contactus.html"
